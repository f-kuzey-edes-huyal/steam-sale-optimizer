...
The main Terraform code for using the Azure platform looks like that, but I could not stay with it as it was not as easy as just five lines. I have prepared [terraform.md](https://github.com/f-kuzey-edes-huyal/steam-sale-optimizer/blob/main/terraform/terraform.md) inside the terraform folder.
