...
def load_csv_to_postgres_and_export():
    try:
        ...
        # Upload CSV dataframes directly using engine (not raw connection)
        ...
        # Read the final combined table into pandas dataframe
        ...
        # Parse owners into min, max, and log mean columns
