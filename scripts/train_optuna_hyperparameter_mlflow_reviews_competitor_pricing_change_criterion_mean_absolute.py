...
def load_and_preprocess_data(filepath):
    ...
    df, tfidf, svd = transform_review_column(df, seed=SEED)
    ...
    return X, y, mlb_genres, mlb_tags, competitor_transformer, tfidf, svd

mlflow.set_tracking_uri(MLFLOW_TRACKING_URI)
mlflow.set_experiment(EXPERIMENT_NAME)
mlflow.sklearn.autolog()

X, y, mlb_genres, mlb_tags, competitor_transformer, tfidf, svd = load_and_preprocess_data(DATA_PATH)
...
with mlflow.start_run(run_name="final_model_run"):
    ...
    mlflow.log_artifact('models/discount_model_pipeline.pkl', artifact_path='artifacts')
    mlflow.log_artifact('models/mlb_genres.pkl', artifact_path='artifacts')
    mlflow.log_artifact('models/mlb_tags.pkl', artifact_path='artifacts')
    mlflow.log_artifact('models/competitor_pricing_transformer.pkl', artifact_path='artifacts')
    mlflow.log_artifact('models/tfidf_vectorizer.pkl', artifact_path='artifacts')
    mlflow.log_artifact('models/svd_transform.pkl', artifact_path='artifacts')
