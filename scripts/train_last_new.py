...
from config.constants import EXPERIMENT_NAME3, DATA_PATH, SEED
...
if __name__ == "__main__":
    # Explicit tracking URI for Docker-based MLflow server
    ...
    def objective(trial):
        ...
        with mlflow.start_run(experiment_id=experiment_id, run_name=f"optuna_{model_type}", nested=True):
    ...
    with mlflow.start_run(experiment_id=experiment_id, run_name="final_model_run"):
