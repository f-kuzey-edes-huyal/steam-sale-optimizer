...
def clean_review(text):
    if pd.isna(text):
        return ""
    # Satır sonları, tab vb. karakterleri boşluk yap
    text = re.sub(r'[\r\n\t]+', ' ', text)
    # Harf, rakam, boşluk ve bazı noktalama işaretleri dışındakileri kaldır
...
def load_csv_to_postgres_and_export():
    ...
    # Normalize release_date to YYYY-MM-DD format
