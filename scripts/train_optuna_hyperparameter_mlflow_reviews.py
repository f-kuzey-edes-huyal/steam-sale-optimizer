...
def load_and_preprocess_data(filepath):
    ...
    features = NUMERIC_FEATURES + ['review_score'] + list(genres_encoded.columns) + list(tags_encoded.columns)
...
mlflow.set_tracking_uri(MLFLOW_TRACKING_URI)  # fixed typo here
